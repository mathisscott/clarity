...
export function small() {
  return html`
    <cds-demo popover>
      <cds-modal __demo-mode size="sm" cds-motion="off">
        <cds-modal-header>
...
export function defaultSize() {
  return html`
    <cds-demo popover>
      <cds-modal __demo-mode cds-motion="off">
        <cds-modal-header>
...
export function large() {
  return html`
    <cds-demo popover>
      <cds-modal __demo-mode size="lg" cds-motion="off">
        <cds-modal-header>
...
export function extraLarge() {
  return html`
    <cds-demo popover>
      <cds-modal __demo-mode size="xl" cds-motion="off">
        <cds-modal-header>
...
export function customStyles() {
  return html`
    ...
    <cds-demo popover>
      <cds-modal __demo-mode class="modal-branding" size="lg" cds-motion="off">
        <cds-modal-header>
