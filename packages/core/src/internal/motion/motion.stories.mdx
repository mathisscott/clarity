...
An animation in the Clarity Motion registry can be overridden anywhere in your application where are you could add an icon to Clarity Core or add a new animation to Clarity Motion.
